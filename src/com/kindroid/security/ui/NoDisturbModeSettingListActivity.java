...
public class NoDisturbModeSettingListActivity extends ListActivity {
	...
	private void loadListAdapter(){
		...
		int mDefaultInterceptMode = sp.getInt(Constant.SHAREDPREFERENCES_NIGHTBLOCKINGRULES, 0);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		editor.putInt(Constant.SHAREDPREFERENCES_NIGHTBLOCKINGRULES, position + 1);		
		editor.commit();
		/*
